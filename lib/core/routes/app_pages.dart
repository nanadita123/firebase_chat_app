...
import '../../presentation/pages/bottom_nav_bar/bottom_nav_bar.dart';
import '../../presentation/pages/home/users_list.dart';
...
class AppPages {
  static Map<String, WidgetBuilder> routes = {
    ...
    AppRoutes.bottomNavBar: (_) =>  BottomNavBar(),
    AppRoutes.home: (_) =>  HomePage(),
    AppRoutes.usersList: (_) =>  UsersList(),
  };
}